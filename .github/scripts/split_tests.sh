...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=976
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=968
    FILE_TIMES[op_tests/test_mla.py]=902
    FILE_TIMES[op_tests/test_mla_v4_nm.py]=847
    FILE_TIMES[op_tests/test_mla_persistent.py]=778
    FILE_TIMES[op_tests/test_pa.py]=634
    FILE_TIMES[op_tests/test_batch_prefill.py]=626
    FILE_TIMES[op_tests/test_mha.py]=612
    FILE_TIMES[op_tests/test_mla_sparse.py]=567
    FILE_TIMES[op_tests/test_mha_varlen.py]=508
    FILE_TIMES[op_tests/test_rope.py]=390
    FILE_TIMES[op_tests/test_topk_plain.py]=383
    FILE_TIMES[op_tests/test_topk_per_row.py]=272
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=258
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=234
    FILE_TIMES[op_tests/test_gated_delta_rule.py]=196
    FILE_TIMES[op_tests/test_moe_topk_gating.py]=185
    FILE_TIMES[op_tests/test_moe_sorting.py]=148
    FILE_TIMES[op_tests/test_moe_2stage.py]=127
    ...
    FILE_TIMES[op_tests/test_pa_sparse_prefill_opus.py]=22
    ...
    FILE_TIMES[op_tests/test_deepgemm.py]=12
    ...
    FILE_TIMES[op_tests/test_gemm_a4w4.py]=3
    ...
    FILE_TIMES[op_tests/test_mla_persistent_round_robin.py]=3
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_v3.py]=732
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=715
    FILE_TIMES[op_tests/triton_tests/conv/test_causal_conv1d.py]=684
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_fp8.py]=656
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8_a_per_token_group_prequant_w_per_batched_tensor_quant.py]=360
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_a16w16.py]=224
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_pe.py]=197
    FILE_TIMES[op_tests/triton_tests/moe/test_moe.py]=166
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=165
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=156
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=154
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=148
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=145
    FILE_TIMES[op_tests/triton_tests/fusions/test_mhc.py]=134
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=123
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8.py]=118
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_mul_add.py]=108
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=103
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_afp4wfp4.py]=102
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing.py]=98
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16_gated.py]=95
    FILE_TIMES[op_tests/triton_tests/normalization/test_rmsnorm.py]=94
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=90
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=88
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=81
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w4.py]=80
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_kv_cache.py]=77
    ...
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_bmm_rope_kv_cache.py]=64
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_int8_smoothquant.py]=55
    FILE_TIMES[op_tests/triton_tests/test_activation.py]=51
    FILE_TIMES[op_tests/triton_tests/attention/test_la.py]=44
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_afp4wfp4_split_cat.py]=44
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16.py]=39
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_reduce_qk_norm_rope_swa_write.py]=37
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_dao_ai.py]=33
    ...
    FILE_TIMES[op_tests/triton_tests/test_gather_kv_b_proj.py]=27
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_bf16.py]=22
    FILE_TIMES[op_tests/triton_tests/quant/test_fused_fp8_quant.py]=20
    ...
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_routing_herd.py]=17
    ...
    FILE_TIMES[op_tests/triton_tests/torch_compile/test_compile_gemm_a16w16.py]=8
