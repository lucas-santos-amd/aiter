...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=1526
    FILE_TIMES[op_tests/test_mla.py]=820
    FILE_TIMES[op_tests/test_mla_persistent.py]=784
    FILE_TIMES[op_tests/test_mha.py]=780
    FILE_TIMES[op_tests/test_pa.py]=631
    FILE_TIMES[op_tests/test_mha_varlen.py]=620
    FILE_TIMES[op_tests/test_batch_prefill.py]=599
    FILE_TIMES[op_tests/test_mla_sparse.py]=576
    FILE_TIMES[op_tests/test_moe_2stage.py]=528
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=498
    FILE_TIMES[op_tests/test_rope.py]=388
    FILE_TIMES[op_tests/test_topk_plain.py]=328
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=257
    FILE_TIMES[op_tests/test_moe_sorting_mxfp4.py]=198
    FILE_TIMES[op_tests/test_moe_sorting.py]=134
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale.py]=131
    FILE_TIMES[op_tests/test_topk_per_row.py]=120
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=118
    FILE_TIMES[op_tests/test_pa_mtp.py]=102
    FILE_TIMES[op_tests/test_moe_tkw1.py]=100
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=83
    FILE_TIMES[op_tests/test_moe_ep.py]=82
    FILE_TIMES[op_tests/test_kvcache.py]=60
    FILE_TIMES[op_tests/test_causal_conv1d.py]=58
    ...
    FILE_TIMES[op_tests/test_mhc.py]=38
    FILE_TIMES[op_tests/test_aiter_add.py]=36
    FILE_TIMES[op_tests/test_aiter_addInp.py]=35
    FILE_TIMES[op_tests/test_batched_gemm_bf16.py]=33
    ...
    FILE_TIMES[op_tests/test_groupnorm.py]=26
    ...
    FILE_TIMES[op_tests/test_pa_v1.py]=17
    FILE_TIMES[op_tests/test_moeTopkSoftmax.py]=16
    FILE_TIMES[op_tests/test_fused_qk_norm.py]=13
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_mha.py]=1425
    FILE_TIMES[op_tests/triton_tests/test_pa_decode_gluon.py]=724
    FILE_TIMES[op_tests/triton_tests/test_causal_conv1d.py]=652
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_decode.py]=637
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a8w8_a_per_token_group_prequant_w_per_batched_tensor_quant.py]=398
    FILE_TIMES[op_tests/triton_tests/attention/test_chunked_pa_prefill.py]=339
    FILE_TIMES[op_tests/triton_tests/attention/test_pa_prefill.py]=314
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a8w8_blockscale.py]=260
    FILE_TIMES[op_tests/triton_tests/attention/test_flash_attn_kvcache.py]=249
    FILE_TIMES[op_tests/triton_tests/moe/test_moe.py]=134
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w16_gated.py]=94
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16.py]=84
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8.py]=72
    ...
    FILE_TIMES[op_tests/triton_tests/gemm/fused/test_fused_gemm_a8w8_blockscale_a16w16.py]=62
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_fav3_sage.py]=25
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_bmm_rope_kv_cache.py]=23
    ...
    FILE_TIMES[op_tests/triton_tests/attention/test_fp8_mqa_logits.py]=15
    FILE_TIMES[op_tests/triton_tests/attention/test_la.py]=15
    FILE_TIMES[op_tests/triton_tests/attention/test_la_paged.py]=15
    FILE_TIMES[op_tests/triton_tests/attention/test_mha_with_sink.py]=15
    FILE_TIMES[op_tests/triton_tests/attention/test_unified_attention.py]=15
    FILE_TIMES[op_tests/triton_tests/fusions/test_fused_mul_add.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/batched/test_batched_gemm_a16wfp4.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/feed_forward/test_ff_a16w16_fused.py]=15
    FILE_TIMES[op_tests/triton_tests/moe/test_moe_gemm_a4w4.py]=15
    FILE_TIMES[op_tests/triton_tests/rope/test_rope.py]=15
    FILE_TIMES[op_tests/triton_tests/test_gated_delta_rule.py]=15
    FILE_TIMES[op_tests/triton_tests/test_gmm.py]=15
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a16w8_blockscale.py]=14
    FILE_TIMES[op_tests/triton_tests/gemm/basic/test_gemm_a8w8_blockscale.py]=8
