...
if [[ "$TEST_TYPE" == "aiter" ]]; then
    ...
    FILE_TIMES[op_tests/test_fused_qk_norm_mrope_cache_quant.py]=1449
    FILE_TIMES[op_tests/test_mla.py]=926
    FILE_TIMES[op_tests/test_mla_persistent.py]=780
    FILE_TIMES[op_tests/test_mha.py]=751
    FILE_TIMES[op_tests/test_pa.py]=659
    FILE_TIMES[op_tests/test_batch_prefill.py]=589
    FILE_TIMES[op_tests/test_mha_varlen.py]=588
    FILE_TIMES[op_tests/test_mla_sparse.py]=576
    FILE_TIMES[op_tests/test_fused_qk_norm_rope_cache_quant.py]=492
    FILE_TIMES[op_tests/test_moe_2stage.py]=452
    FILE_TIMES[op_tests/test_rope.py]=411
    FILE_TIMES[op_tests/test_topk_plain.py]=330
    FILE_TIMES[op_tests/test_gemm_a8w8_blockscale.py]=258
    FILE_TIMES[op_tests/test_concat_cache_mla.py]=256
    FILE_TIMES[op_tests/test_moe_sorting.py]=151
    FILE_TIMES[op_tests/test_moe_dp_share_expert.py]=119
    FILE_TIMES[op_tests/test_topk_per_row.py]=116
    FILE_TIMES[op_tests/test_moe_tkw1.py]=105
    FILE_TIMES[op_tests/test_pa_mtp.py]=100
    FILE_TIMES[op_tests/test_gemm_a8w8.py]=84
    FILE_TIMES[op_tests/test_moe_ep.py]=78
    FILE_TIMES[op_tests/test_kvcache.py]=60
    FILE_TIMES[op_tests/test_causal_conv1d.py]=59
    FILE_TIMES[op_tests/test_quant.py]=51
    FILE_TIMES[op_tests/test_activation.py]=45
    ...
    FILE_TIMES[op_tests/test_aiter_add.py]=34
    FILE_TIMES[op_tests/test_batched_gemm_bf16.py]=34
    FILE_TIMES[op_tests/test_moe_sorting_mxfp4.py]=30
    ...
    FILE_TIMES[op_tests/test_moeTopkSoftmax.py]=17
