...
class Layernorm2dFwdWithAdd(torch.autograd.Function):
...
def layer_norm(
    ...
    #TODO: Add Doc
    """
    return LayerNorm.apply(input, weight, bias, eps, torch.is_grad_enabled())
...
def layernorm2d_fwd_with_add(
    ...
    #TODO: Add Doc
    """
    return Layernorm2dFwdWithAdd.apply(
        out,
        input,
        residual_in,
        residual_out,
